    ...
    return (
        <div>
            ...
            <div className="container">
                ...
                <div className={toggle === 1 ? "show-content bg-purple mt-5" : "content" }>
                    <h1>TAB 1</h1>
                    <p>Content 1 <br /> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ullam, voluptatibus!</p>
                </div>
                <div className={toggle === 2 ? "show-content bg-yellow mt-5" : "content"}>
                    <h1>TAB 2</h1>
                ...
                <div className={toggle === 3 ? "show-content bg-blue mt-5" : "content"}>
                    <h1>TAB 3</h1>
